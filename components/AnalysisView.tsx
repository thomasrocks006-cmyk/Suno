          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
              {song.analysis.scoreBreakdown.map((item, i) => {
                  ...
                  <div 
                      ...
                      onClick={() => {
                          onExpandScoreItem(expandedScoreItem === i ? null : i);
                      }}
                  >
      ...
      <div className="bg-blue-900/20 border border-blue-500/30 p-3 md:p-4 rounded-lg">
        <div className="flex justify-between items-center mb-2 gap-2">
            ...
            <div className="flex gap-2">
                ...
                {/* Smart Editor button removed - not accessible from AnalysisView */}
            </div>
        </div>
